...
const categories = [
  { label: 'Sách điện tử', icon: <Tablet className="w-7 h-7 text-red-500" />, isEBook: true },
          ...
          >
            <div className="flex min-w-full justify-between items-center px-2">
              {categories.slice(0, 6).map((cat, idx) => (
                <div key={idx} className="flex flex-col items-center gap-4 group/item cursor-pointer w-[15%]" onClick={() => handleCategoryClick(cat)}>
