              ...
              <div className="bg-slate-50 p-8 rounded-[2.5rem] border border-slate-100 space-y-6 sticky top-24 shadow-sm">
                ...
                <div className="pt-8 border-t border-slate-200 space-y-4">
                  <div className="space-y-3">
                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Ảnh đại diện</label>
                    {editingItem?.image_url ? (
                      <div className="relative group">
                        <img src={editingItem.image_url} className="w-full aspect-video object-cover rounded-xl border border-slate-200" />
                        <button
                      ...
                      <div className="space-y-2">
                        <p className="text-[10px] text-slate-500 italic">Bấm chọn ảnh từ thư viện:</p>
                        <div className="grid grid-cols-3 gap-2">
                          {tempGallery.map((url, i) => (
                            <button
                              key={i}
                              onClick={() => setEditingItem({ ...editingItem, image_url: url })}
                              className="aspect-square rounded-lg overflow-hidden border-2 border-slate-200 hover:border-emerald-500 transition-colors"
                            >
                      ...
                      <div className="py-6 text-center border-2 border-dashed border-slate-200 rounded-xl bg-white/50">
                        ...
                        <p className="text-[10px] text-slate-400">Tải ảnh lên thư viện trước</p>
                      </div>
                    )}
                  </div>
                  <div className="space-y-2">
